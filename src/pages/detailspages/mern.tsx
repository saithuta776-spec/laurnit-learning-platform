...
import MernImg from "@/assets/forDetail/mern.jpg";

const mernStackData = {
  title: "MERN Full-Stack Web Development Professional Certificate",
  description:
    "Master full-stack web development with MongoDB, Express.js, React, and Node.js. Build scalable RESTful APIs, modern dynamic frontend interfaces, and production-ready applications from scratch.",
  category: "Computer Science",
  instructor: "Sayar Kyaw Ye",
  instructorRole: "Full-Stack Lead · Senior Software Engineer",
  instructorBio:
    "Sayar Htet Wai has years of hands-on experience building production full-stack architectures and web services. He specializes in scalable JavaScript systems, clean component patterns, and modern backend integration.",
  price: "800,000 Ks",
  ...
  series: [
    {
      id: 101,
      number: "Course 1",
      title: "Frontend Foundations with Modern React & TypeScript",
      lessons: [
        "React Component Lifecycle & JSX Architecture (14:20)",
        "Managing State, Props & Custom Hooks (18:45)",
        "Client-Side Routing with React Router (16:10)",
      ],
    },
    {
      id: 102,
      ...
      lessons: [
        "Node.js Runtime & Event Loop Architecture (15:30)",
        "Building RESTful API Endpoints with Express (22:10)",
        "Middleware Patterns & Request Validation (19:40)",
      ],
    },
    {
      id: 103,
      number: "Course 3",
      title: "Database Design & Management with MongoDB & Mongoose",
      lessons: [
        "Document Database Principles & MongoDB Atlas Setup (12:50)",
        "Designing Schemas & Data Models with Mongoose (24:15)",
        "CRUD Operations & Aggregation Pipelines (21:30)",
      ],
    },
    {
      id: 104,
      number: "Course 4",
      title: "Full-Stack Integration, Auth & Security",
      lessons: [
        "Connecting React Frontend with Express API (20:15)",
        "JWT Authentication & Secure Password Hashing (28:40)",
        "Handling State Management & API Errors (17:50)",
      ],
    },
    {
      id: 105,
      number: "Course 5",
      title: "Production Deployment & Capstone Web App",
      lessons: [
        "Environment Variables & Security Best Practices (16:20)",
        "Deploying MERN Apps to Cloud Platforms (30:10)",
        "Final Production Capstone Presentation & Review (45:00)",
      ],
    },
  ],
};
          ...
          <div className="space-y-4 rounded-2xl border-t border-gray-100 p-4 pt-8">
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-start">
              ...
              <div className="flex-1 space-y-2">
                <div className="">
                  <Link
                    to="/instructors/kyawye"
                    className="text-base font-bold text-gray-900"
                  >
                    {mernStackData.instructor}
                  </Link>
