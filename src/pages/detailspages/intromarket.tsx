...
import intromarket from "@/assets/forDetail/intromarket.jpg";

const introMarketing = {
  title: "Introduction to Marketing",
  description:
    "Build a strong understanding of fundamental marketing principles. Explore core market research, the 4 Ps of marketing, branding fundamentals, and integrated communications to launch your business career.",
  category: "Business",
  instructor: "Tr Cherry Mya",
  instructorRole: "Marketing Consultant · Senior Brand Manager",
  instructorBio:
    "Tr Cherry Mya has over a decade of industry experience shaping corporate brand identity and consumer strategy. She specializes in breaking down foundational marketing frameworks into actionable business tools.",
  price: "550,000 Ks",
  ...
  includes: [
    ...
    "25 practical worksheets & templates",
    "8 real-world brand case studies",
  ...
  series: [
    {
      id: 501,
      number: "Course 1",
      title: "Foundations of Marketing & the Business Environment",
      lessons: [
        "What is Marketing? Core Concepts & Value Creation (13:15)",
        "Analyzing the Macro & Micro Environment (PESTLE & SWOT) (17:40)",
        "Understanding Market Segmentation & Target Audiences (16:10)",
      ],
    },
    {
      id: 502,
      ...
      lessons: [
        "Psychological Factors Driving Buyer Decisions (19:25)",
        "Qualitative vs. Quantitative Market Research (21:50)",
        "Designing Surveys and Conducting Customer Interviews (18:30)",
      ],
    },
    {
      id: 503,
      number: "Course 3",
      title: "The Marketing Mix: Product & Price Strategy",
      lessons: [
        "Product Lifecycle Stages & Portfolio Management (22:10)",
        "Value-Based vs. Cost-Plus Pricing Frameworks (20:05)",
        "New Product Development & Positioning (15:45)",
      ],
    },
    {
      id: 504,
      number: "Course 4",
      title: "The Marketing Mix: Place & Integrated Promotion",
      lessons: [
        "Distribution Channels & Retail Partnerships (18:50)",
        "Integrated Marketing Communications (IMC) (23:15)",
        "Public Relations, Sponsorships & Direct Marketing (16:40)",
      ],
    },
    {
      id: 505,
      number: "Course 5",
      title: "Brand Identity & Marketing Plan Capstone",
      lessons: [
        "Building Brand Equity & Visual Assets (25:00)",
        "Budgeting, Metrics & Measuring ROI (21:10)",
        "Capstone Project: Structuring a Complete Marketing Plan (38:30)",
      ],
    },
  ],
};
