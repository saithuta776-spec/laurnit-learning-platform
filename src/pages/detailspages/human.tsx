...
import HsImg from "@/assets/forDetail/human_psychology.jpg"; // Adjust import path if needed
...
const psychologyData = {
  ...
  instructorRole: "Lecturer in Psychology & Behavioral Science Practitioner",
  instructorBio:
    "Dr Kaung Zaw is an experienced psychology educator and practitioner dedicated to making behavioral science accessible to everyone. He specializes in cognitive patterns, emotional intelligence, personal resilience, and human interaction dynamics.",
  duration: "1 month",
  level: "Beginner",
  price: 240000,
  ...
  image: HsImg,
  includes: [
    "20+ hours on-demand video lessons",
    "Self-reflection worksheets & psychological self-assessment tools",
    "Case study analysis & practical behavioral guides",
  ...
  curriculum: [
    {
      id: "module-1",
      title: "Foundations of Human Behavior & Mindset",
      lessons: [
        "Introduction to Psychological Foundations & Cognitive Biases",
        "Understanding Emotions, Stress Reactions & Self-Regulation",
        "Interpersonal Dynamics: Communication, Perception & Empathy",
        "Motivation, Habit Formation & Behavioral Change Psychology",
        "Mental Well-being, Mindset Building & Applied Resilience",
      ],
    },
  ],
};

export default function HumanPsychologyPage() {
  ...
  return (
    <div className="container mx-auto px-6 py-10">
      ...
      <div className="mb-6 space-x-2 text-xs font-bold text-gray-400">
        ...
        <span>/</span>
        <span className="text-gray-600">{psychologyData.category}</span>
      </div>
      ...
      <div className="grid grid-cols-1 gap-10 lg:grid-cols-3">
        ...
        <div className="space-y-10 lg:col-span-2">
          ...
          <div className="space-y-3">
            <div className="flex gap-2">
              <span className="rounded-full bg-emerald-100 px-2.5 py-1 text-[10px] font-black tracking-wider text-emerald-800 uppercase">
                {psychologyData.category}
              </span>
              <span className="rounded-full bg-gray-100 px-2.5 py-1 text-[10px] font-medium text-gray-800">
                Level: {psychologyData.level}
              </span>
              <span className="rounded-full bg-gray-100 px-2.5 py-1 text-[10px] font-medium text-gray-800">
                Duration: {psychologyData.duration}
              </span>
            </div>
            <h1 className="text-3xl font-black tracking-tight text-gray-950 sm:text-4xl">
              {psychologyData.title}
            </h1>
            <p className="text-sm leading-relaxed text-gray-600 sm:text-base">
              Explore the core principles of human behavior, cognitive
              processes, and emotional intelligence. Gain valuable insights into
              how people think, communicate, and form habits to improve your
          ...
          <div className="overflow-hidden rounded-[2rem] shadow-md">
            <img
              src={psychologyData.image}
              alt={psychologyData.title}
          ...
          <div className="space-y-4 rounded-[2rem] border border-gray-100 bg-white p-6 shadow-sm">
            ...
            <div className="grid grid-cols-1 gap-3 text-xs font-medium text-gray-700 sm:text-sm lg:grid-cols-2">
              <p className="flex items-start gap-2">
                <span>✅</span> Key Principles of Cognitive & Behavioral
                Psychology
              </p>
              <p className="flex items-start gap-2">
                <span>✅</span> Emotional Intelligence & Stress Management
                Skills
              </p>
              <p className="flex items-start gap-2">
                <span>✅</span> Interpersonal Communication & Empathy
                Development
              </p>
              <p className="flex items-start gap-2">
                <span>✅</span> Psychological Hacks for Habit Building &
                Resilience
              </p>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              {psychologyData.curriculum.map((module) => {
          ...
          <div className="space-y-4 rounded-2xl border-t border-gray-100 p-4 pt-8">
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-start">
              ...
              <div className="flex-1 space-y-2">
                <div>
                  <Link
                    to="/instructors/kaungZaw"
                    className="text-base font-bold text-gray-900"
                  >
                    {psychologyData.instructor}
                  </Link>
                  <p className="text-xs font-medium text-gray-500">
                    {psychologyData.instructorRole}
                  </p>
                </div>
                <p className="text-xs leading-relaxed text-gray-600 sm:text-sm">
                  {psychologyData.instructorBio}
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="lg:col-span-1">
          <div className="sticky top-5 space-y-6 rounded-[2rem] border border-gray-100 bg-white p-6 shadow-xl">
            ...
            <div className="space-y-1">
              <div className="flex items-center gap-3">
                <span className="text-3xl font-black tracking-tight text-gray-950">
                  {psychologyData.price.toLocaleString()} Ks
                </span>
              ...
              <p className="text-xs font-bold text-gray-400 line-through">
                {psychologyData.originalPrice.toLocaleString()} Ks
              </p>
            ...
            <button className="w-full rounded-2xl bg-emerald-500 py-3.5 text-xs font-black text-white shadow-md transition-colors hover:bg-emerald-600 sm:text-sm">
              Enroll Now ({psychologyData.price.toLocaleString()} Ks)
            </button>
            ...
            <div className="space-y-3">
              ...
              <ul className="space-y-2.5 text-xs font-semibold text-gray-600">
                {psychologyData.includes.map((feature, idx) => (
