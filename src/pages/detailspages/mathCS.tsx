...
import McsImg from "@/assets/forDetail/mathCS.jpg";

const mathCS = {
  title: "Mathematics For Computer Science",
  description:
    "Master the essential mathematical foundations behind modern computing. Explore discrete mathematics, linear algebra, probability, and logic designed specifically for computer science and software engineering.",
  ...
  price: "700,000 Ks",
  originalPrice: "900,000 Ks",
  discount: "22% off",
  image: McsImg,
  includes: [
    "3 months complete program",
    "80+ hours on-demand video",
    "40 downloadable problem sets",
    "20 mathematical logic exercises",
  ...
  series: [
    {
      id: 301,
      number: "Course 1",
      title: "Discrete Mathematics & Formal Logic",
      lessons: [
        "Propositional Logic & Truth Tables (14:20)",
        "Predicates, Quantifiers & Proof Techniques (18:45)",
        "Set Theory, Relations & Functions (15:30)",
      ],
    },
    {
      id: 302,
      number: "Course 2",
      title: "Combinatorics, Counting & Graph Theory",
      lessons: [
        "Permutations, Combinations & Pigeonhole Principle (20:10)",
        "Introduction to Graphs, Trees & Paths (22:15)",
        "Graph Coloring & Shortest Path Algorithms (25:00)",
      ],
    },
    {
      id: 303,
      number: "Course 3",
      title: "Number Theory & Cryptography Essentials",
      lessons: [
        "Divisibility, Modular Arithmetic & GCD (19:40)",
        "Prime Numbers & Euclid's Algorithm (16:25)",
        "Public Key Cryptography & RSA Encryption (28:10)",
      ],
    },
    {
      id: 304,
      number: "Course 4",
      title: "Linear Algebra for CS & Machine Learning",
      lessons: [
        "Vectors, Matrices & Linear Transformations (24:30)",
        "Eigenvalues, Eigenvectors & Dot Products (21:15)",
        "Matrix Multiplication in Computer Graphics (18:50)",
      ],
    },
    {
      id: 305,
      number: "Course 5",
      title: "Probability, Statistics & Algorithmic Analysis",
      lessons: [
        "Conditional Probability & Bayes' Theorem (22:40)",
        "Random Variables & Expectation Values (19:05)",
        "Asymptotic Notation: Big-O, Big-Omega & Theta (35:00)",
      ],
    },
  ],
};

export default function MathematicsComputerScience() {
  // Accordion State: Stores IDs of opened sub-courses
  const [expandedSeriesIds, setExpandedSeriesIds] = useState<number[]>([301]);
  ...
  // Get current active course configuration data
  const data = mathCS;
