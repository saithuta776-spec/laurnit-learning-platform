...
import CsImg from "@/assets/forDetail/foundationCS.jpg"; // Adjust path if needed

const foundationCS = {
  title: "Foundation For Computer Science",
  description:
    "Build a rock-solid foundation in computer science. Learn core programming logic, algorithms, data structures, and computer systems fundamentals to jumpstart your software engineering journey.",
  ...
  includes: [
    ...
    "15 algorithmic coding exercises",
  ...
  series: [
    {
      id: 201,
      number: "Course 1",
      title: "Introduction to Computer Systems & Hardware Logic",
      lessons: [
        "How Computers Think: Binary, Bytes & Memory (12:10)",
        "Understanding CPU, RAM, and Storage Architecture (15:40)",
        "Compilers, Interpreters, and Execution Cycles (11:25)",
      ],
    },
    {
      id: 202,
      ...
      lessons: [
        "Pseudocode and Flowchart Design (14:20)",
        "Control Structures: Loops, Conditions & Logic Gates (18:05)",
        "Deconstructing Complex Problems into Sub-tasks (16:30)",
      ],
    },
    {
      id: 203,
      number: "Course 3",
      title: "Core Data Structures & Algorithmic Thinking",
      lessons: [
        "Arrays, Linked Lists, and Memory Allocation (20:15)",
        "Stacks, Queues, and Hash Tables Explained (22:45)",
        "Introduction to Sorting & Searching Algorithms (25:10)",
      ],
    },
    {
      id: 204,
      ...
      lessons: [
        "Classes, Objects, and Encapsulation (17:30)",
        "Inheritance, Polymorphism, and Abstraction (21:00)",
        "Designing Scalable OOP Architectures (19:20)",
      ],
    },
    {
      id: 205,
      number: "Course 5",
      title: "Operating Systems, Networking & Final Project",
      lessons: [
        "Operating System Basics: Processes & Threads (18:40)",
        "How the Internet Works: HTTP, IP & DNS (23:15)",
        "Capstone Project: Building a Custom Algorithmic CLI Tool (40:00)",
      ],
    },
  ],
};

export default function FoundationComputerScience() {
