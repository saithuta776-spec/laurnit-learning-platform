...
import SeImg from "@/assets/forDetail/selling.jpg"; // Adjust import path if needed

const sellingTechniqueData = {
  id: 18,
  title: "Selling Technique for 21st Century",
  category: "Business",
  instructor: "Sayar Chan Aye",
  instructorRole: "Sales Strategy & Modern Marketing Specialist",
  instructorBio:
    "Sayar Chan Aye is a business strategist and sales coach specializing in modern buyer behavior, consultative selling, and digital sales funnels. He helps sales professionals and entrepreneurs adapt to modern market dynamics and close deals effectively.",
  duration: "1 month",
  level: "Beginner",
  price: 100000,
  ...
  includes: [
    ...
    "15 downloadable sales scripts & frameworks",
    "6 interactive closing roleplay exercises",
  ...
  curriculum: [
    {
      id: "module-1",
      title: "21st Century Selling Masterclass",
      lessons: [
        "Understanding 21st Century Buyer Psychology & Behavior",
        "Consultative Selling vs. Traditional Hard Selling",
        "Social Selling & Digital Pitching Strategies",
        "Overcoming Objections & Value-Based Price Positioning",
        "Closing Techniques & Modern Relationship Management",
      ],
    },
  ],
};

export default function SellingTechniquePage() {
  ...
  return (
    <div className="container mx-auto px-6 py-10">
      ...
      <div className="mb-6 space-x-2 text-xs font-bold text-gray-400">
        ...
        <span>/</span>
        <span className="text-gray-600">{sellingTechniqueData.category}</span>
      </div>
      ...
      <div className="grid grid-cols-1 gap-10 lg:grid-cols-3">
        ...
        <div className="space-y-10 lg:col-span-2">
          ...
          <div className="space-y-3">
            <div className="flex gap-2">
              <span className="rounded-full bg-emerald-100 px-2.5 py-1 text-[10px] font-black tracking-wider text-emerald-800 uppercase">
                {sellingTechniqueData.category}
              </span>
              <span className="rounded-full bg-gray-100 px-2.5 py-1 text-[10px] font-medium text-gray-800">
                Level: {sellingTechniqueData.level}
              </span>
              <span className="rounded-full bg-gray-100 px-2.5 py-1 text-[10px] font-medium text-gray-800">
                Duration: {sellingTechniqueData.duration}
              </span>
            </div>
            <h1 className="text-3xl font-black tracking-tight text-gray-950 sm:text-4xl">
              {sellingTechniqueData.title}
            </h1>
            <p className="text-sm leading-relaxed text-gray-600 sm:text-base">
              Transform your sales approach for today’s empowered digital
              consumers. Learn how to shift from pushy tactics to consultative
              selling, handle complex client objections, and build long-lasting
          ...
          <div className="overflow-hidden rounded-[2rem] shadow-md">
            <img
              src={sellingTechniqueData.image}
              alt={sellingTechniqueData.title}
          ...
          <div className="space-y-4 rounded-[2rem] border border-gray-100 bg-white p-6 shadow-sm">
            ...
            <div className="grid grid-cols-1 gap-3 text-xs font-medium text-gray-700 sm:text-sm lg:grid-cols-2">
              <p className="flex items-start gap-2">
                <span>✅</span> Modern Buyer Psychology & Decision Frameworks
              </p>
              <p className="flex items-start gap-2">
                <span>✅</span> Consultative Pitching & Value Proposition Design
              </p>
              <p className="flex items-start gap-2">
                <span>✅</span> Objection Handling & High-Yield Closing Tactics
              </p>
              <p className="flex items-start gap-2">
                <span>✅</span> Social Selling & Digital Outreach Strategies
              </p>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              {sellingTechniqueData.curriculum.map((module) => {
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-start">
              ...
              <div className="flex-1 space-y-2">
                <div>
                  ...
                  >
                    {sellingTechniqueData.instructor}
                  </Link>
                  <p className="text-xs font-medium text-gray-500">
                    {sellingTechniqueData.instructorRole}
                  </p>
                </div>
                <p className="text-xs leading-relaxed text-gray-600 sm:text-sm">
                  {sellingTechniqueData.instructorBio}
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="lg:col-span-1">
          <div className="sticky top-5 space-y-6 rounded-[2rem] border border-gray-100 bg-white p-6 shadow-xl">
            ...
            <div className="space-y-1">
              <div className="flex items-center gap-3">
                <span className="text-3xl font-black tracking-tight text-gray-950">
                  {sellingTechniqueData.price.toLocaleString()} Ks
                </span>
              ...
              <p className="text-xs font-bold text-gray-400 line-through">
                {sellingTechniqueData.originalPrice.toLocaleString()} Ks
              </p>
            ...
            <button className="w-full rounded-2xl bg-emerald-500 py-3.5 text-xs font-black text-white shadow-md transition-colors hover:bg-emerald-600 sm:text-sm">
              Enroll Now ({sellingTechniqueData.price.toLocaleString()} Ks)
            </button>
            ...
            <div className="space-y-3">
              ...
              <ul className="space-y-2.5 text-xs font-semibold text-gray-600">
                {sellingTechniqueData.includes.map((feature, idx) => (
