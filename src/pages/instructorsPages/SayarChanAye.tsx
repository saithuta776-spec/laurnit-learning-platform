...
const instructorData = {
  name: "Sayar Chan Aye",
  role: "Lead Digital Marketing & Design Specialist",
  avatarLetters: "CA",
  bio: "Sayar Chan Aye is a versatile marketing strategist and visual design instructor. He combines modern digital growth strategies with practical design skills to help students master branding, content creation, and modern sales techniques.",
  stats: [
    { label: "Active Students", value: "3,400+" },
    { label: "Course Completion", value: "92%" },
    { label: "Years Experience", value: "8+ Yrs" },
  ],
  credentials: [
    "Senior Digital Marketing Consultant & Strategist",
    "Expert in Visual Design & Graphic Fundamentals",
    "21st Century Sales & Brand Growth Specialist",
  ],
  coursesTaught: [
    {
      id: 8,
...
export default function SayarChanAyePage() {
  return (
