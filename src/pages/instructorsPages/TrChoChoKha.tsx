...
const instructorData = {
  name: "Tr Cho Cho Kha",
  role: "Startup & Entrepreneurship Specialist",
  avatarLetters: "CK",
  bio: "Tr Cho Cho Kha specializes in startup growth, business modeling, and venture creation. She empowers aspiring entrepreneurs with practical frameworks to transform innovative ideas into viable, scalable businesses.",
  stats: [
    { label: "Active Students", value: "1,200+" },
    { label: "Course Completion", value: "96%" },
    { label: "Years Experience", value: "5+ Yrs" },
  ],
  credentials: [
    "Venture Strategist & Business Model Consultant",
    "Expert in Early-Stage Startup Pitching & Funding",
    "Lead Faculty for Business Growth & Innovation",
  ],
  coursesTaught: [
    {
      id: 10,
...
export default function TeacherChoChoKha() {
  return (
