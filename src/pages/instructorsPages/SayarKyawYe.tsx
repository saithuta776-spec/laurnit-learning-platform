...
const instructorData = {
  name: "Sayar Kyaw Ye",
  role: "Senior Full-Stack & Web Architecture Instructor",
  avatarLetters: "KY",
  bio: "Sayar Kyaw Ye specializes in web development and full-stack architecture, focusing on modern JavaScript frameworks and scalable web applications. Together with his team of assistant teachers, he guides students through real-world software engineering practices and production-ready MERN development.",
  stats: [
    { label: "Active Students", value: "2,100+" },
    { label: "Course Completion", value: "95%" },
    { label: "Years Experience", value: "7+ Yrs" },
  ],
  credentials: [
    "Full-Stack Web Architect & Senior Developer",
    "Specialist in React, Node.js, Express & MongoDB (MERN)",
    "Lead Instructor for Web Engineering Tracks",
  ],
  coursesTaught: [
    {
      id: 3,
...
export default function SayarKyawYePage() {
  return (
