...
const instructorData = {
  name: "Sayar Nay Win Naing",
  role: "Senior Mobile Architecture & Cross-Platform Lead",
  avatarLetters: "NW",
  bio: "Sayar Nay Win Naing specializes in cross-platform mobile engineering, native device integration, and scalable app architectures. With years of hands-on industry experience, he guides students from core programming fundamentals to deploying production-ready apps on both the App Store and Google Play.",
  stats: [
    { label: "Active Students", value: "1,950+" },
    { label: "Course Completion", value: "93%" },
    { label: "Years Experience", value: "8+ Yrs" },
  ],
  credentials: [
    "Senior Mobile App Architect & Full-Stack Lead",
    "Specialist in Cross-Platform Mobile Frameworks & Firebase",
    "Lead Faculty for Mobile Software Engineering Tracks",
  ],
  coursesTaught: [
    {
      id: 14,
...
export default function SayarNayWinNaingPage() {
  return (
